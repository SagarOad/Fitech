  ...
  return (
    <div>
      <section className="section section-features pt-8 px-8 lg:px-24 lg:py-2 mx-auto">
        <div className="features h-auto section-features-wrap backdrop-blur-xl bg-white/30 block md:flex items-center px-8 md:px-24 my-4 justify-between rounded-3xl">
          <div className="w-[100%] md:w-[50%]">
            ...
            <p className="leading-normal text-white opacity-85 mt-3 font-[nexa-light] font-bold text-base md:text-[21px] md:text-left">
          ...
          <div className="w-[100%] mt-4 md:mt-0 md:w-[50%] flex justify-center md:justify-end">
            <button
              ...
              className="get-started text-white opacity-75 py-4 px-6 rounded-lg font-[poppins] text-[21px]"
            >
              Get Started
            </button>
          </div>
