        ...
        <div className="block">
          <div>
            <div className="flex flex-col justify-between">
              <img className="w-[220px] mb-3 mx-auto md:mx-0" src={Logo} />
              ...
              <div>
                <ul className="flex flex-col leading-10 p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 md:border-0">
                  <li className="pl-3 py-2 md:py-0 md:border-0 border-t-2 border-white text-end">
                    <a
                      href="#projects"
                  ...
                  <li className="pl-[3.5rem] py-2 md:py-0 md:border-0 border-t-2 border-white text-end">
                    <a
                      href="#pricing"
                      className="text-[#212121] hover:text-[#f58020] font-sans font-bold text-[18px] md:text-[18px]"
                    >
